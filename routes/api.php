...
Route::Post('/dashboard/edit/hotel/{id}', [App\Http\Controllers\Api\Dashboard\HotelController::class , 'update']);
Route::Post('/dashboard/add_service/hotel/{id}', [App\Http\Controllers\Api\Dashboard\HotelController::class , 'add_service']);
...
Route::Post('/dashboard/edit/restaurant/{id}', [App\Http\Controllers\Api\Dashboard\RestaurantController::class , 'update']);
Route::Post('/dashboard/add_service/restaurant/{id}', [App\Http\Controllers\Api\Dashboard\RestaurantController::class , 'add_service']);
...
Route::Post('/dashboard/edit/team/{id}', [App\Http\Controllers\Api\Dashboard\TeamController::class , 'update']);
...
Route::Post('/dashboard/edit/match/{id}', [App\Http\Controllers\Api\Dashboard\MatchController::class , 'update']);
...
Route::Post('/dashboard/edit/stadium/{id}', [App\Http\Controllers\Api\Dashboard\StadiumController::class , 'update']);
