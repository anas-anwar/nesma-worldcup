        ...
        <div class="card-body m-3">
            <form method="POST" action="{{ URL('hotels') }}">
                ...
                <div class="form-group">
                    ...
                    <input value="{{ old('latitude') }}" type="number" class="form-control" id="exampleInputLatitude" name="latitude" placeholder="Enter Hotel Latitude" min="-90" max="90" step="0.01" required autofocus>
                </div>
                <div class="form-group">
                    <label for="exampleInputLongtude">Longtude</label>
                    <input value="{{ old('longtude') }}" type="number" class="form-control" id="exampleInputLongtude" name="longtude" placeholder="Enter Hotel Longtude" min="-180" max="180" step="0.01" required autofocus>
                </div>
                <div class="form-group">
