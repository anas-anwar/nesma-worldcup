            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active"><a href="{{url('hotels/addImages/'.$hotel->id)}}">Add Image to {{ $hotel->name }}</a></li>
                    </ol>
                </div>
            </div>
    ...
    <section class="content">
        ...
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Add Image to {{ $hotel->name }}</h3>
            ...
            <div class="bg-light">
                <div class="card-body m-3">
                    <form method="POST" action="{{ URL('hotels/storeImages/'. $hotel->id)}}" id="addImages" enctype="multipart/form-data">
                        @csrf
