        ...
        <div class="card-body m-3">
            <form method="POST" action="{{ URL('hotels/'. $hotel->id) }}">
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" id="exampleInputLatitude" value="{{ old('hotel_url',$hotel->latitude) }}" name="latitude" placeholder="Enter Hotel Latitude" min="-90" max="90" step="0.01" required autofocus>
                </div>
                <div class="form-group">
                    <label for="exampleInputLongtude">Longtude</label>
                    <input type="number" class="form-control" id="exampleInputLongtude" value="{{ old('hotel_url',$hotel->longtude) }}" name="longtude" placeholder="Enter Hotel Longtude" min="-180" max="180" step="0.01" required autofocus>
                </div>
                <div class="form-group">
