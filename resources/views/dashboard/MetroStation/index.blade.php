  ...
  <section class="content">
    ...
    <div class="card">
      ...
      <div class="card-body">
        ...
        @endif
        @endif
        <a href="{{ URL('metrostations/create' ) }}" type="button" class="my-3 btn btn-primary">
          <i class="fa fa-plus"></i> Create New Metro Station</a>
        {!! $dataTable->table([
        'id' => 'dataTable',
