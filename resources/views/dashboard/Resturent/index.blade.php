    ...
    <div class="card">
      ...
      <div class="card-body">
        ...
        @if (session()->has('add_status'))
            ...
            @endif
        @endif
        <a href="{{ URL('resturents/create' ) }}" type="button" class="my-3 btn btn-primary" >
          <i class="fa fa-plus"></i> Create New Resturent</a>
        {!! $dataTable->table([
        'id' => 'dataTable',
