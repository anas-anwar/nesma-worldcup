...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1>Add Image to  {{ $resturent->name }}</h1>
        </div>
        <div class="col-sm-6">
...
<div class="card">
    <div class="card-header">
        <h3 class="card-title">Add Image to {{ $resturent->name }}</h3>
    ...
    <div class="bg-light">
        <div class="card-body m-3">
            <form method="POST" action="{{route('resturent.storeImages',$resturent->id)}}" id="addImages" enctype="multipart/form-data"  >
             @csrf
