  ...
  <section class="content">
    ...
    <div class="card">
      ...
      <div class="card-body">
        ...
        @endif
        @endif
        <a href="{{ URL('touristicplaces/create' ) }}" type="button" class="my-3 btn btn-primary">
          <i class="fa fa-plus"></i> Create New Touristic Place</a>
        {!! $dataTable->table([
        'id' => 'dataTable',
