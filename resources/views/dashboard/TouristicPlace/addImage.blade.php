...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Add Image to {{ $touristic_place->name }}</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active"><a href="{{url('touristicplaces/addImages/'.$touristic_place->id)}}">Add Image to {{ $touristic_place->name }}</a></li>
                    </ol>
                </div>
            </div>
    ...
    <section class="content">
        ...
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Add Image to {{ $touristic_place->name }}</h3>
            ...
            <div class="bg-light">
                <div class="card-body m-3">
                    <form method="POST" action="{{ URL('touristicplaces/storeImages/'. $touristic_place->id)}}" id="addImages" enctype="multipart/form-data">
                        @csrf
