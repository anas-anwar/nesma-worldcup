  ...
  <section class="content">
    ...
    <div class="card">
      ...
      <div class="card-body">
        ...
        <div class="alert alert-success">{{ session('add_status') }}</div>
        @else
        <div class="alert alert-danger">FAILD</div>
        @endif
        @endif
        <a href="{{ URL('notifications/create' ) }}" type="button" class="my-3 btn btn-primary">
          <i class="fa fa-plus"></i> Create New Notification</a>
        {!! $dataTable->table([
        'id' => 'dataTable',
